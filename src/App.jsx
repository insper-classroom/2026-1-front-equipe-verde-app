...
const selectOptions = {
  ...
  Qualidade: [
    { value: "9.5", label: "Excelente" },
    { value: "7.5", label: "Boa" },
    { value: "5.5", label: "M\u00e9dia" },
    { value: "3.5", label: "Ruim" },
    { value: "1.5", label: "P\u00e9ssima" },
  ],
  Condicao: [
    { value: "9.5", label: "Excelente" },
    { value: "7.5", label: "Boa" },
  ...
  const summaryItems = useMemo(
    () => [
      ...
      },
      {
        icon: CheckCircle2,
        label: "Qualidade",
        value: getOptionLabel("Qualidade", payload.Qualidade),
      },
      {
        icon: CheckCircle2,
        label: "Condi\u00e7\u00e3o",
        value: getOptionLabel("Condicao", payload.Condicao),
      },
      {
        icon: Home,
        label: "Idade",
